...
public class CsvFileWriter {
    ...
    public static void writeCsvFile(String fileName) {
        ...
        Student student1 = new Student(1, "Ahmed", "Mohamed", "M", 33);
        ...
        Student student7 = new Student(7, "A H M", "Shahparan", "M", 29);
        Student student8 = new Student(7, "A H M", "Shahparan", "M", 29);
...
Map.Entry<String, String> map = new HashMap<>();
map.put(Studentq.getFristname(), student1);
